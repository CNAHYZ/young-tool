...
import com.antaiib.framework.excel.core.handler.style.CommonCellWriteHandler;
...
import com.antaiib.framework.excel.core.head.HeadMeta;
...
public abstract class AbstractSheetWriteHandler implements SheetWriteProcessor, ApplicationContextAware {
    ...
    public void export(Object o, HttpServletResponse response, ResponseExcel responseExcel) {
        ...
        ExcelUtils.setResponseHeaders(response, name);
        write(o, response, responseExcel);
    }

    /**
     * 通用的获取ExcelWriterBuilder方法
     *
    ...
    public ExcelWriterBuilder getExcelWriterBuilder(HttpServletResponse response, ResponseExcel responseExcel) {
        ExcelWriterBuilder writerBuilder = EasyExcel.write(response.getOutputStream())
                ...
                .registerWriteHandler(new CommonCellWriteHandler())
                // 注册默认列宽样式
